class TextClassificationBaseException(Exception):
    ...
    Example::
        ...
        >>> raise TextClassificationBaseException("error message")
    """
...
class UnsupportedModelNameError(TextClassificationBaseException):
    """
...
class UnsupportedOptimizerNameError(TextClassificationBaseException):
    """
